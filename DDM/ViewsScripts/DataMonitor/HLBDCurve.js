    ...
    drawDataLines: function (canvas, name) {
        ...
        for (var i = 0; i < lineArr.length; i++) {
            ...
            for (var p = 0; p < lineArr[i].points.length; p += 1) {
                obj['x' + (p + 1)] = parseFloat(layer.x) + parseFloat(lineArr[i].points[p][0]);

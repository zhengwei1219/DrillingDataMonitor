...
function SNBXCurveObj(headCanvas, dataCanvas) {
    BaseCurve.call(this, headCanvas, dataCanvas);
    var arr = new Array();
    arr.push(new rect("ee", 150));
    arr.push(new rect("深\n度", 50));
    arr.push(new rect("aa", 150));
    arr.push(new rect("bb", 150));
    arr.push(new rect("cc", 150));
    arr.push(new rect("孔隙度/\n密度", 150));
    arr.push(new rect("gg", 150));
    arr.push(new rect("dd", 150));
    arr.push(new rect("荧\n光\n级\n别", 50));
    arr.push(new rect("ff", 150));
    this.rectArray = arr;
}

SNBXCurveObj.prototype = new BaseCurve();
SNBXCurveObj.prototype.startIntervval = function () {
    efreshCount = 0;
    HLBD = this;
    setInterval(this.drawDataLines, this.config.efreshTime);
}
SNBXCurveObj.prototype.drawHeadFram = function () {
    ...
    var headLineStr = '{"电阻率": [{"strokeStyle": "black","name": "FTC","unit": "(m/hr)","startMark": "150","endMark": "0"}],"钻压/钻速/垂深": [{"strokeStyle": "black","name": "FTC","unit": "(m/hr)","startMark": "150","endMark": "0"},{"strokeStyle": "red","name": "FTC","unit": "(m/hr)","startMark": "150","endMark": "0"}]}';
...
SNBXCurveObj.prototype.clearDataFram = function () {
    var arr = this.rectArray;
    for (var i = 0; i < arr.length; i++) {
...
SNBXCurveObj.prototype.drawDataFram = function () {
...
SNBXCurveObj.prototype.getData = function (name) {
...
SNBXCurveObj.prototype.drawDataLines = function () {
    efreshCount++;
    if (efreshCount > 3) {
        //clearInterval(time);
        return;
...
SNBXCurveObj.prototype.drawLines = function (canvas, name, type, count) {

...
SNBXCurveObj.prototype = {
    buildRect: function () {
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            this.drawLines(this.dataCanvas, name, "X", 5);
            this.drawLines(this.dataCanvas, name, "Depth", 5);
            this.drawLines(this.dataCanvas, name, "Area", 2);
            this.drawLines(this.dataCanvas, name, "dataLine", 5);
    ...
    getData: function (name) {
        ...
        switch (name) {
            ...
            default:
                ...
                dataArry.push(new datalineObj(strokeStyle, one, new datalineDesc("G_C2", "(ppm)", 150, 0)));
                var two = [
                                    [70, 0],
                                    [73, 150],
                                    [76, 170],
                ...
                dataArry.push(new datalineObj(strokeStyle, two, new datalineDesc("G_NC4", "(ppm)", 150, 0)));
